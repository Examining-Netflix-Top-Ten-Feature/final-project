...
|-- Updated and Final Netflix Top 10 Model.ipynb
|-- DATA
...
Run the Jupyter notebook called Updated and Final Netflix Top 10 Model.ipynb to run through the machine learning modeling steps.
